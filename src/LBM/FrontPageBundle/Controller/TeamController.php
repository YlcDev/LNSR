...
use LBM\FrontPageBundle\Entity\Team;
...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $teams = $em->getRepository('FrontPageBundle:Team')->findAll();
    ...
    {
        $team = new Team();
        $form = $this->createForm('LBM\FrontPageBundle\Form\TeamType', $team);
    ...
    {
        $deleteForm = $this->createDeleteForm($team);
        $editForm = $this->createForm('LBM\FrontPageBundle\Form\TeamType', $team);
