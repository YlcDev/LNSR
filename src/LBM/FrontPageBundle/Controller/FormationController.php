...
use LBM\FrontPageBundle\Entity\Formation;
...
class FormationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $formations = $em->getRepository('FrontPageBundle:Formation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('LBM\FrontPageBundle\Form\FormationType', $formation);
    ...
    {
        $deleteForm = $this->createDeleteForm($formation);
        $editForm = $this->createForm('LBM\FrontPageBundle\Form\FormationType', $formation);
