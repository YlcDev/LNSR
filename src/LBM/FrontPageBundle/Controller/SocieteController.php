...
use LBM\FrontPageBundle\Entity\Societe;
...
class SocieteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $societes = $em->getRepository('FrontPageBundle:Societe')->findAll();
    ...
    {
        $societe = new Societe();
        $form = $this->createForm('LBM\FrontPageBundle\Form\SocieteType', $societe);
    ...
    {
        $deleteForm = $this->createDeleteForm($societe);
        $editForm = $this->createForm('LBM\FrontPageBundle\Form\SocieteType', $societe);
